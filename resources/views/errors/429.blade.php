...
<div class="flex flex-col items-center justify-center h-screen bg-opacity-90">
    <div class="bg-amber-900 w-3/6 h-4/6 flex flex-col items-center justify-center shadow-2xl">
        <img src="{{asset('src/canon.png')}}" alt="Pirate Ship" class="w-32 h-32 mb-8">
        <h1 class="text-4xl text-black my-4">¡Argh, demasiadas solicitudes!</h1>
        <p class="text-lg text-red-600 mb-8">¡Nos han bombardeado con demasiadas solicitudes, capitán!</p>
