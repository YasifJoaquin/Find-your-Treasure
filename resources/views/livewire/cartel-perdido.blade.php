<div>
    <div class="absolute inset-0 z-40 w-screen h-auto flex flex-col">
        ...
        <div class="w-3/5 h-auto m-auto rounded-xl bg-center flex flex-col justify-center" style="background-image: url({{ asset('src/fondo-claro.png') }});">
            <form wire:submit.prevent="crearCartel" class="col-span-8 h-auto">
                ...
                <div class="grid grid-cols-8 h-full text-center">
                    ...
                    <div class="col-span-4 block text-lg text-gray-700 mb-2 tracking-wider">
                        @error('image')
                        <span class="mt-1 error text-black font-semibold bg-orange-300 rounded-xl py-1 px-2"> {{ $message }} </span>
                        @else
                        Retrato del tesoro
                        @enderror
                    </div>
                    ...
                    <div class=" col-span-2 flex justify-center items-center">
                        <button type="submit" class="bg-amber-800 hover:bg-amber-900 text-white tracking-widest py-2 px-4 my-3 rounded-full">
                            Crear Cartel
                        </button>
                    </div>
