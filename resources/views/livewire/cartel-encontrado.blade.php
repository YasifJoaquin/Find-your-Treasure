            ...
            <form wire:submit.prevent="crearCartel" class="col-span-8 h-full">
                ...
                <div class="grid grid-cols-8 h-full text-center">
                    ...
                    <div class="col-span-4">
                        ...
                        <input type="text" id="pregunta1" class="border-2 focus:bg-gray-200 border-amber-900 bg-gray-300 hover:bg-gray-200 rounded-full w-4/6 text-base">
                    </div>
                    <div class="col-span-4">
                        <label for="pregunta2" class="block text-lg text-gray-700 mb-2 tracking-wider">¿Cuál es la marca del tesoro, bucanero?</label>
                        <input type="text" id="pregunta2" class="border-2 focus:bg-gray-200 border-amber-900 bg-gray-300 hover:bg-gray-200 rounded-full w-4/6 text-base">
                    </div>
    
                    <div class="col-span-4">
                        <label for="pregunta3" class="block text-lg text-gray-700 mb-2 tracking-wider">¿De que color es el color del tesoro?</label>
                        <input type="text" id="pregunta3" class="border-2 focus:bg-gray-200 border-amber-900 bg-gray-300 hover:bg-gray-200 rounded-full w-4/6 text-base">
                    </div>
                    <div class="col-span-4">
                        <label for="pregunta4" class="block text-lg text-gray-700 mb-2 tracking-wider">Explicais más sobre este tesoro, bucanero</label>
                        <input type="text" id="pregunta4" class="border-2 focus:bg-gray-200 border-amber-900 bg-gray-300 hover:bg-gray-200 rounded-full w-4/6 text-base">
                    </div>
    
                    <div class="col-span-4">
                        <label for="pregunta5" class="block text-lg text-gray-700 mb-2 tracking-wider">¿Donde has encontrado ese botín, camarada?</label>
                        <input type="text" id="pregunta5" class="border-2 focus:bg-gray-200 border-amber-900 bg-gray-300 hover:bg-gray-200 rounded-full w-4/6 text-base">
                    </div>
                    <div class="col-span-4">
